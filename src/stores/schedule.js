  ...
  const generateDayTasks = (dayNumber) => {
    ...
    if (dayNumber === 2) {
      return [
        ...
        { id: 9, time: '12:00-12:30', activity: '午餐时间', description: '好好吃饭，不挑食\n吃完后自己收拾碗筷', category: 'daily', completed: false },
        {
          id: 10,
          time: '12:30-15:30',
          activity: '💃 跳舞课',
        ...
        { id: 11, time: '15:30-16:00', activity: '回家休息', description: '喝水、换衣服、吃点水果\n休息一下恢复体力', category: 'break', completed: false },
        { id: 12, time: '16:00-16:30', activity: '午休补充', description: '可以小睡一会儿\n或安静地休息', category: 'daily', completed: false },
        {
          id: 13,
          time: '16:30-17:00',
          activity: '🏃 户外运动（30分钟）',
        ...
        { id: 15, time: '17:30-18:00', activity: '自由活动', description: '玩玩具、画画、听音乐\n可以玩益智玩具或手工', category: 'break', completed: false },
